    ...
    try:
        ...
        report_prompt = {
            ...
            "content": (
                ...
                "7. Ortografía y expresión escrita: "
                "   - SOLO reporta errores ortográficos REALES que hayas detectado en las respuestas del candidato. "
                "   - Si NO hubo errores ortográficos, indica explícitamente: 'No se detectaron errores ortográficos.' "
                "   - NO inventes ejemplos ni pongas faltas que no ocurrieron. "
                "   - Formato de ejemplo real: Escribió 'ola' en lugar de 'hola' (entre comillas la palabra exacta mal escrita). "
