      ...
      <div class="card-body">
        <div class="row">
          <div class="col-12 mb-3">
            <label class="form-label">1. Selecciona una provincia:</label>
            <JsonSelect
        ...
        <div class="mb-3">
          <label for="promptInput" class="form-label">3. Escribe tu pregunta:</label>
          <textarea
            id="promptInput"
            v-model="prompt"
            class="form-control"
          ...
          <div class="form-text text-muted">
            Presiona <strong>Enter</strong> para enviar, <strong>Shift + Enter</strong> para nueva
            línea.
          </div>
        </div>
